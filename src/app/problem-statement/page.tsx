                ...
                <AnimatePresence>
                    {selectedTrack && (
                        <motion.div
                            ...
                            onClick={() => { setSelectedTrack(null); setExpandedPS(null); }}
                        >
                            <div className="flex flex-col items-center w-full max-w-7xl my-auto py-8">
                                ...
                                >
                                    ...
                                    <div className="p-6 md:p-10 space-y-10">
                                        ...
                                        {/* Rules & Guidelines */}
                                        <div className="bg-black/30 border border-white/5 rounded-2xl" style={{ padding: "1.5rem" }}>
                                            <h3 className="text-xl md:text-2xl font-display text-white flex items-center tracking-wide" style={{ marginBottom: "1.5rem" }}>
                                                <span className="bg-(--accent) w-2 h-6 md:h-8 inline-block" style={{ marginRight: "1rem" }}></span>
                                                Rules & Guidelines
                                            </h3>
                                                    ...
                                                    <AnimatePresence>
                                                        {expandedPS === ps.id && (
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <div>
                                                                        <h4 className="text-2xl md:text-3xl font-body text-[var(--accent)] font-bold tracking-wide" style={{ marginBottom: "1rem" }}>
                                                                            {ps.title}
                                                                        </h4>
                                                                    ...
                                                                    {ps.coreFunctionalities.length > 0 && (
                                                                        <div style={{ marginTop: "2rem" }}>
                                                                            <h5 className="text-white font-bold font-body text-xl md:text-2xl tracking-wide" style={{ marginBottom: "1rem" }}>Core Functionalities:</h5>
                                                                    ...
                                                                    {ps.note && (
                                                                        <div className="bg-white/5 border border-white/10 rounded-xl" style={{ padding: "1.25rem 1.5rem", marginTop: "1.5rem" }}>
